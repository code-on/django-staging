...
var DateTimeShortcuts = {
    ...
    init: function() {
        ...
        for (i=0; i<inputs.length; i++) {
            var inp = inputs[i];
            if (inp.getAttribute('type') == 'text' && inp.className.match(/vTimeField/) && !inp.className.match(/processed/)) {
                DateTimeShortcuts.addClock(inp);
            }
            else if (inp.getAttribute('type') == 'text' && inp.className.match(/vDateField/)  && !inp.className.match(/processed/)) {
